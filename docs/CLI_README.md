...
After seeding the database, you can test the CLI with the sample data provided. The seeding script creates default users for testing purposes. Contact the developer for access credentials.
